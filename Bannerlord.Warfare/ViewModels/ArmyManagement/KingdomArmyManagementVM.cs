...
namespace Warfare.ViewModels.ArmyManagement
{
    internal class KingdomArmyManagementVM : ViewModel
    {
        ...
        private void OnRefresh()
        {
            ...
            if (CanBoostCohesion)
            {
                TextObject textObject = GameTexts.FindText("str_add_cohesion_to_army");
        ...
        public void ExecuteDisbandArmy()
        {
            if (CanDisbandArmy)
            {
                InformationManager.ShowInquiry(new InquiryData(GameTexts.FindText("str_disband_army").ToString(), Army.LeaderParty == MobileParty.MainParty ? GameTexts.FindText("str_kingdom_disband_player_army").ToString() : GameTexts.FindText("str_kingdom_disband_npc_army").ToString(), isAffirmativeOptionShown: true, isNegativeOptionShown: true, GameTexts.FindText("str_yes").ToString(), GameTexts.FindText("str_no").ToString(), delegate
                {
                    DisbandArmy();
                }, null));
            }
