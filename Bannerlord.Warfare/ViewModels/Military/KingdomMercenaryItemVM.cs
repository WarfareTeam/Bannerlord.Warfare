...
namespace Warfare.ViewModels.Military
{
    public class KingdomMercenaryItemVM : KingdomItemVM
    {
        ...
        public override void RefreshValues()
        {
            ...
            if (IsHired)
            {
                HiredText = Clan == Clan.PlayerClan ? "Under contract" : Clan.MapFaction != Hero.MainHero.MapFaction ? "Already hired" : !Hero.MainHero.IsFactionLeader ? "Hired by your faction" : "Hired by you";
