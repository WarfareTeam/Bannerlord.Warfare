...
namespace Warfare.ViewModels.Military
{
    public class KingdomMilitaryVM : KingdomCategoryVM
    {
        ...
        public override void RefreshValues()
        {
            ...
            MercenariesText = GameTexts.FindText("str_mercenaries").ToString();
            PartiesText = GameTexts.FindText("str_parties").ToString();
            ManageText = GameTexts.FindText("str_manage").ToString();
            ManageActionExplanationText = GameTexts.FindText("str_manage_army_explanation").ToString();
            DisbandText = GameTexts.FindText("str_disband").ToString();
            DisbandActionExplanationText = GameTexts.FindText("str_kingdom_disband_army_explanation").ToString();
            HireText = GameTexts.FindText("str_hire").ToString();
            HireActionExplanationText = GameTexts.FindText("str_kingdom_hire_mercenary_explanation").ToString();
            ExtendText = GameTexts.FindText("str_extend").ToString();
            ExtendActionExplanationText = GameTexts.FindText("str_kingdom_extend_mercenary_explanation").ToString();
            FireText = GameTexts.FindText("str_fire").ToString();
            FireActionExplanationText = GameTexts.FindText("str_kingdom_fire_mercenary_explanation").ToString();
            CategoryNameText = GameTexts.FindText("str_military").ToString();
        ...
        private bool GetCanChangeCurrentArmyLeaderWithReason(out TextObject disabledReason)
        {
            ...
            {
                disabledReason = GameTexts.FindText("str_warning_not_enough_parties");
                return false;
            }

            disabledReason = GameTexts.FindText("str_change_army_leader");
            return true;
        }
        ...
        private bool GetCanSplitCurrentArmyWithReason(out TextObject disabledReason)
        {
            ...
            disabledReason = GameTexts.FindText("str_split_army");
            return true;
        }
        ...
        private bool GetCanManageCurrentArmyWithReason(out TextObject disabledReason)
        {
            ...
            {
                disabledReason = GameTexts.FindText("str_manage_army_restricted");
                return false;
            }
        ...
        private bool GetArmyActionIsEnabledWithReason(out TextObject disabledReason)
        {
            ...
            {
                disabledReason = GameTexts.FindText("str_cannot_manage_army_while_mercenary");
                return false;
            }
            ...
            {
                disabledReason = GameTexts.FindText("str_action_disabled_reason_army_siege");
                return false;
            }
            ...
            if (mapEvent != null)
            {
                ...
                disabledReason = GameTexts.FindText("str_action_disabled_reason_army_in_event");
                return false;
            }
        ...
        private void RefreshCurrentMercenaryVisuals(KingdomMercenaryItemVM item)
        {
            if (item != null)
            {
                ...
                GameTexts.SetVariable("LEFT", "Contract Cost");
        ...
        public void OpenChangeLeaderPopup()
        {
            ...
            ClanCardSelectionInfo obj = new ClanCardSelectionInfo(GameTexts.FindText("str_change_army_leader"), GetArmyLeaderCandidates(), OnChangeLeaderOver, isMultiSelection: false);
        ...
        public void ExecuteSplitArmy()
        {
            if (CurrentSelectedArmy != null)
            {
                string inquiryText = GameTexts.FindText("str_split_army_inquiry").SetTextVariable("MIN_COST", MinimumArmyCost).SetTextVariable("MAX_COST", TotalArmyCost).ToString();
                if (CurrentSelectedArmy.Army.LeaderParty == MobileParty.MainParty)
                {
                    inquiryText += GameTexts.FindText("str_split_army_inquiry_warning").ToString();
                }
                InformationManager.ShowInquiry(new InquiryData(GameTexts.FindText("str_split_army").ToString(), inquiryText, isAffirmativeOptionShown: true, isNegativeOptionShown: true, GameTexts.FindText("str_yes").ToString(), GameTexts.FindText("str_no").ToString(), OpenSplitArmyPopup, null));
            }
        }
        ...
        public void OpenSplitArmyPopup()
        {
            ...
            {
                Action<ClanCardSelectionInfo> openPopup = new Action<ClanCardSelectionInfo>(_cardSelectionPopup.Open);
                ClanCardSelectionInfo obj = new ClanCardSelectionInfo(GameTexts.FindText("str_split_army"), GetArmyLeaderCandidates(), OnSplitArmyLeaderSelectOver, isMultiSelection: false);
                openPopup.Invoke(obj);
            }
        }
        ...
        private void ExecuteDisbandCurrentArmy()
        {
            ...
            {
                InformationManager.ShowInquiry(new InquiryData(GameTexts.FindText("str_disband_army").ToString(), CurrentSelectedArmy.IsMainArmy ? GameTexts.FindText("str_kingdom_disband_player_army").ToString() : GameTexts.FindText("str_kingdom_disband_npc_army").ToString(), isAffirmativeOptionShown: true, isNegativeOptionShown: true, GameTexts.FindText("str_yes").ToString(), GameTexts.FindText("str_no").ToString(), DisbandCurrentArmy, null));
            }
        }
